...
public class Costos extends javax.swing.JPanel {
    ...
    public Costos() {
        ...
        OrdenCompra op = new OrdenCompra();
        int a = op.tablaOC.getRowCount();
        for(int i = 0; i<a; i++){
        String nombre = op.tablaOC.getValueAt(i, 0).toString();
        tablaCos.setValueAt(nombre, i, 0);
            }
    }
    ...
    private void initComponents() {
        ...
        jScrollPane1.setViewportView(tablaCos);
        ...
        jScrollPane2.setViewportView(tablareales);
